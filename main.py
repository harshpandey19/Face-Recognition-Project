...
img1 = face_recognition.load_image_file('elonmusk.jpg')
img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2RGB)
img1Test = face_recognition.load_image_file('elonmusk2.jpg')
...
cv2.imshow('elonmusk', img1)
cv2.imshow('elonmusk Test', img1Test)
cv2.waitKey(0)
